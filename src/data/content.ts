...
const fa: Dictionary = {
  ...
  about: {
    ...
    paragraphs: [
      ...
      "هنوز در ابتدای مسیر حرفه‌ای‌ام هستم و این را یک مزیت می‌دانم؛ ابزارهای جدید را سریع یاد می‌گیرم، از کم‌تجربه‌ترین‌بودن در تیم نمی‌ترسم، و ترجیح می‌دهم چیزی واقعی و ناقص بسازم تا چیزی نظری و کامل.",
    ],
    internshipNote:
